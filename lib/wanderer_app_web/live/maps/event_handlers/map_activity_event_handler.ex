defmodule WandererAppWeb.MapActivityEventHandler do
  ...
  def handle_ui_event("show_activity", params, socket) do
    # Redirect to the MapCoreEventHandler implementation which aggregates by user
    MapCoreEventHandler.handle_ui_event("show_activity", params, socket)
  end
