defmodule WandererAppWeb.ApiRoutes do
  ...
  @route_definitions %{
    "1" => [
      ...
      # Note: Character API intentionally NOT exposed for security reasons.
      # Character information is only available via Access Lists API to prevent
      # unauthorized access to character data.
      ...
      # Access Lists API (Map Webhook Subscriptions now auto-generated by AshJsonApi)
      %RouteSpec{
        verb: :get,
        path: ~w(api v1 acls),
