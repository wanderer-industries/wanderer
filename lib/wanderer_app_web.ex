defmodule WandererAppWeb do
  ...
  def static_paths,
    do:
      ~w(assets fonts images icons sounds favicon.ico site.webmanifest apple-touch-icon.png web-app-manifest-192x192.png web-app-manifest-512x512.png web-app-manifest.webp web-app-manifest-wide.webp robots.txt woff woff2 lottie)
