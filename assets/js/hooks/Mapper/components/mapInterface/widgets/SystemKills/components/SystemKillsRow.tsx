...
export const KillRow: React.FC<KillRowProps> = ({ kill, systemName }) => {
          ...
          <div className="flex items-center space-x-2">
            ...
            {victimCharUrl && (
              <a href={zkillLink('character', kill.victim_char_id)} target="_blank" rel="noopener noreferrer">
                <img src={victimCharUrl} alt="VictimCharacter" style={{ width: 28, height: 28, borderRadius: '50%' }} />
              </a>
            )}
          ...
          <div className="flex justify-end space-x-2">
            ...
            <div className="w-10 flex flex-col items-center">
              ...
              {!isNpc && attackerAllianceUrl && (
                <a href={zkillLink('alliance', kill.final_blow_alliance_id)} target="_blank" rel="noopener noreferrer">
                  <img
